...
month = '08';%considering only January month of 2013
...
%        l = l1;
        ...
        for i=1:3 
            ...
            time_stamp = m2(cty_tx_ind{1,i},1);%m2(:,1);
            speed_col = m2(cty_tx_ind{1,i},2);%m2(:,2);
...
%                            w2=0;
                            ...
                            for k=1:length(c2)%-1
                                ...
                                ts_ind = floor(mod(time_st(c2(k)+1),86400)/300)+1;% included in DEC 2017
                                vel1{i,l,ts_ind} = [vel1{i,l,ts_ind},speed(c2(k))];% included in DEC 2017
%                                                                 
%                                 
%                                 if (c2(k+1)==c2(k)+1)
%                                     w2=w2+time(c2(k+1));
...
save(['Wait_time_taxis_bang',month,'_v2.mat'],'vel1');