...
if     isempty(setdiff(x,floor(x))), f_dattype = 'INTS';  %modified again by Alfred on 16th Feb 2018
...
switch f_dattype,
    ...
    case 'REAL',
        ...
        figure;
        h(1) = loglog(c(:,1),c(:,2),'bo','MarkerSize',8,'MarkerFaceColor',[1 1 1]); hold on;  %% modified from 'bo' to 'b' by Alfred for single vehicle plots
