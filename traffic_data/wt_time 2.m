...
%                wait{i,l} = cell(1,no_tx);
                ...
                for j=1:no_tx
                    ...
                    if(length(ind)>60)
                        ...
                        v2=find(speed<15);%intersect(find(speed<5),find(speed>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
...
save(['Wait_time_taxis_avg_15_20_vel_bombay_bang_delhi',month]);
