...
function w = wt_time_v6(month,days);
...
%                wait{i,l} = cell(1,no_tx);
                ...
                for j=1:no_tx
                    ...
                    if(length(ind)>60)
                        ...
                        v1a=find(avg_kph<0.025);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v1b=find(avg_kph<0.025);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v2a=find(avg_kph<0.05);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v2b=find(avg_kph<0.05);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v3a=find(avg_kph<0.075);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v3b=find(avg_kph<0.075);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v4a=find(avg_kph<0.1);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v4b=find(avg_kph<0.1);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v5a=find(avg_kph<0.125);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v5b=find(avg_kph<0.125);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v6a=find(avg_kph<0.15);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v6b=find(avg_kph<0.15);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v7a=find(avg_kph<0.175);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v7b=find(avg_kph<0.175);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v8a=find(avg_kph<0.2);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v8b=find(avg_kph<0.2);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v9a=find(avg_kph<0.225);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v9b=find(avg_kph<0.225);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v10a=find(avg_kph<2.25);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c10a))
                            ...
                            for k=1:length(c10a)-1
                                if (c10a(k+1)==c10a(k)+1)
                                    ...
                                    wait10a{i,l,taxi_no(j)+1} = [wait10a{i,l,taxi_no(j)+1},w10a];
                                    w10a=0;
                                end
                            end
                        end
                        ...
                        v10b=find(avg_kph<2.25);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c10b))
                            ...
                            for k=1:length(c10b)-1
                                if (c10b(k+1)==c10b(k)+1)
                                    ...
                                    wait10b{i,l,taxi_no(j)+1} = [wait10b{i,l,taxi_no(j)+1},w10b];
                                    w10b=0;
                                end
                            end
                        end
 ...
 w=D;
save(['Waiting_time_taxis_half_avg_very_low_bombay_bang_delhi',month,'.mat']);
