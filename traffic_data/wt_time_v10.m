...
function w = wt_time_v10(month,days);
...
%                                     wait9b{i,l,taxi_no(j)+1} = [wait9b{i,l,taxi_no(j)+1},w9b];
                        ...
                        if (~isempty(c10a))
                            ...
                            for k=1:length(c10a)-1
                                if (c10a(k+1)==c10a(k)+1)
...
%                                     wait9a{i,l,taxi_no(j)+1} = [wait9a{i,l,taxi_no(j)+1},w9a];
                        ...
                        if (~isempty(c10b))
                            ...
                            for k=1:length(c10b)-1
                                if (c10b(k+1)==c10b(k)+1)
...
%         inter_len1 = length(intersect(cty_tx_ind{1,1},cty_tx_ind{1,2}))
%         inter_len2 = length(intersect(cty_tx_ind{1,2},cty_tx_ind{1,3}))
%         inter_len3 = length(intersect(cty_tx_ind{1,1},cty_tx_ind{1,3}))
            
        
        clear m1 m m2 file   
 end%end for 30 days
 w=D;
save(['Waiting_time_taxis_half_avg_below_1_bombay_bang_delhi_2013',month,'.mat']);
