...
function w = wt_time_v4(month,days);
...
%                wait{i,l} = cell(1,no_tx);
                ...
                for j=1:no_tx
                    ...
                    if(length(ind)>60)
                        ...
                        v1a=find(avg_kph<2.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v1b=find(avg_kph<2.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v2a=find(avg_kph<7.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v2b=find(avg_kph<7.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v3a=find(avg_kph<12.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v3b=find(avg_kph<12.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v4a=find(avg_kph<17.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v4b=find(avg_kph<17.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v5a=find(avg_kph<22.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v5b=find(avg_kph<22.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v6a=find(avg_kph<27.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v6b=find(avg_kph<27.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v7a=find(avg_kph<32.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v7b=find(avg_kph<32.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v8a=find(avg_kph<37.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        v8b=find(avg_kph<37.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
 ...
 w=D;
save(['Waiting_time_taxis_half_avg_2_5_to_37_5_bombay_bang_delhi',month,'.mat']);
