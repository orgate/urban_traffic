...
function w = wt_time_v11(month,days);
...
wt10a=cell(3,D);%waiting times while considering dist/time
wait10a = cell(3,D,40000);%assuming taxi ids are about 39340
...
wt10b=cell(3,D);%waiting times while considering dist/time
wait10b = cell(3,D,40000);%assuming taxi ids are about 39340
...
%avg = [];%collecting speeds of taxis for every 5 mins interval
...
%                wait{i,l} = cell(1,no_tx);
                ...
                for j=1:no_tx
                    ...
                    if(length(ind)>60)
                        ...
                        v1a=find(avg_kph<0.1);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c1a))
                            ...
                            for k=1:length(c1a)
                                if ((length(c1a)>1) && (c1a(k+1)==c1a(k)+1))
...
%                                     wait1a{i,l,taxi_no(j)+1} = [wait1a{i,l,taxi_no(j)+1},w1a];
                        ...
                        v1b=find(avg_kph<0.1);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c1b))
                            ...
                            for k=1:length(c1b)
                                if ((length(c1b)>1) && (c1b(k+1)==c1b(k)+1))
...
%                                     wait1b{i,l,taxi_no(j)+1} = [wait1b{i,l,taxi_no(j)+1},w1b];
                        ...
                        v2a=find(avg_kph<0.2);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c2a))
                            ...
                            for k=1:length(c2a)
                                if ((length(c2a)>1) && (c2a(k+1)==c2a(k)+1))
...
%                                     wait2a{i,l,taxi_no(j)+1} = [wait2a{i,l,taxi_no(j)+1},w2a];
                        ...
                        v2b=find(avg_kph<0.2);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c2b))
                            ...
                            for k=1:length(c2b)
                                if ((length(c2b)>1) && (c2b(k+1)==c2b(k)+1))
...
%                                     wait2b{i,l,taxi_no(j)+1} = [wait2b{i,l,taxi_no(j)+1},w2b];
                        ...
                        v3a=find(avg_kph<0.3);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c3a))
                            ...
                            for k=1:length(c3a)
                                if ((length(c3a)>1) && (c3a(k+1)==c3a(k)+1))
...
%                                     wait3a{i,l,taxi_no(j)+1} = [wait3a{i,l,taxi_no(j)+1},w3a];
                        ...
                        v3b=find(avg_kph<0.3);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c3b))
                            ...
                            for k=1:length(c3b)
                                if ((length(c3b)>1) && (c3b(k+1)==c3b(k)+1))
...
%                                     wait3b{i,l,taxi_no(j)+1} = [wait3b{i,l,taxi_no(j)+1},w3b];
                        ...
                        v4a=find(avg_kph<0.4);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c4a))
                            ...
                            for k=1:length(c4a)
                                if ((length(c4a)>1) && (c4a(k+1)==c4a(k)+1))
...
%                                     wait4a{i,l,taxi_no(j)+1} = [wait4a{i,l,taxi_no(j)+1},w4a];
                        ...
                        v4b=find(avg_kph<0.4);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c4b))
                            ...
                            for k=1:length(c4b)
                                if ((length(c4b)>1) && (c4b(k+1)==c4b(k)+1))
...
%                                     wait4b{i,l,taxi_no(j)+1} = [wait4b{i,l,taxi_no(j)+1},w4b];
                        ...
                        v5a=find(avg_kph<0.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c5a))
                            ...
                            for k=1:length(c5a)
                                if ((length(c5a)>1) && (c5a(k+1)==c5a(k)+1))
...
%                                     wait5a{i,l,taxi_no(j)+1} = [wait5a{i,l,taxi_no(j)+1},w5a];
                        ...
                        v5b=find(avg_kph<0.5);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c5b))
                            ...
                            for k=1:length(c5b)
                                if ((length(c5b)>1) && (c5b(k+1)==c5b(k)+1))
...
%                                     wait5b{i,l,taxi_no(j)+1} = [wait5b{i,l,taxi_no(j)+1},w5b];
                        ...
                        v6a=find(avg_kph<0.6);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c6a))
                            ...
                            for k=1:length(c6a)
                                if ((length(c6a)>1) && (c6a(k+1)==c6a(k)+1))
...
%                                     wait6a{i,l,taxi_no(j)+1} = [wait6a{i,l,taxi_no(j)+1},w6a];
                        ...
                        v6b=find(avg_kph<0.6);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c6b))
                            ...
                            for k=1:length(c6b)
                                if ((length(c6b)>1) && (c6b(k+1)==c6b(k)+1))
...
%                                     wait6b{i,l,taxi_no(j)+1} = [wait6b{i,l,taxi_no(j)+1},w6b];
                        ...
                        v7a=find(avg_kph<0.7);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c7a))
                            ...
                            for k=1:length(c7a)
                                if ((length(c7a)>1) && (c7a(k+1)==c7a(k)+1))
...
%                                     wait7a{i,l,taxi_no(j)+1} = [wait7a{i,l,taxi_no(j)+1},w7a];
                        ...
                        v7b=find(avg_kph<0.7);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c7b))
                            ...
                            for k=1:length(c7b)
                                if ((length(c7b)>1) && (c7b(k+1)==c7b(k)+1))
...
%                                     wait7b{i,l,taxi_no(j)+1} = [wait7b{i,l,taxi_no(j)+1},w7b];
                        ...
                        v8a=find(avg_kph<0.8);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c8a))
                            ...
                            for k=1:length(c8a)
                                if ((length(c8a)>1) && (c8a(k+1)==c8a(k)+1))
...
%                                     wait8a{i,l,taxi_no(j)+1} = [wait8a{i,l,taxi_no(j)+1},w8a];
                        ...
                        v8b=find(avg_kph<0.8);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c8b))
                            ...
                            for k=1:length(c8b)
                                if ((length(c8b)>1) && (c8b(k+1)==c8b(k)+1))
...
%                                     wait8b{i,l,taxi_no(j)+1} = [wait8b{i,l,taxi_no(j)+1},w8b];
                        ...
                        v9a=find(avg_kph<0.9);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c9a))
                            ...
                            for k=1:length(c9a)
                                if ((length(c9a)>1) && (c9a(k+1)==c9a(k)+1))
...
%                                     wait9a{i,l,taxi_no(j)+1} = [wait9a{i,l,taxi_no(j)+1},w9a];
                        ...
                        v9b=find(avg_kph<0.9);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        ...
                        if (~isempty(c9b))
                            ...
                            for k=1:length(c9b)
                                if ((length(c9b)>1) && (c9b(k+1)==c9b(k)+1))
...
%                                     wait9b{i,l,taxi_no(j)+1} = [wait9b{i,l,taxi_no(j)+1},w9b];
                        ...
                        v10a=find(avg_kph<1.0);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        t10a=find(time<(5*60+1));%indices of where the time diffence between gps data is less than 5 minutes
                        tt10a = find((mod(time_st,86400)>9000) & (mod(time_st,86400)<59400))-1; % times stamp between 8am to 10pm
                        c10a=intersect(v10a,intersect(t10a,tt10a));%common indices between the v1 and t1

                        if (~isempty(c10a))
                            w10a=time(c10a(1));

                            for k=1:length(c10a)b
                                if ((length(c10a)>1) && (c10a(k+1)==c10a(k)+1))
                                    w10a=w10a+time(c10a(k+1));
                                    %t_seg{i,l}=[t_seg{i,l},time(c(k)+1)];
                                else
                                    wt10a{i,l}=[wt10a{i,l},w10a];%storing waiting time for 30 days for three city
%                                     wait9a{i,l,taxi_no(j)+1} = [wait9a{i,l,taxi_no(j)+1},w9a];
                                    w10a=0;
                                end
                            end
                        ...
                        v10b=find(avg_kph<1.0);%intersect(find(avg_kph<5),find(avg_kph>0));%indices of where the avg velocity is less than 5kphr
                        %v1=find((avg_kph<5));
                        t10b=find(time<(5*60+1));%indices of where the time diffence between gps data is less than 5 minutes
                        tt10b = find((mod(time_st,86400)<=9000) | (mod(time_st,86400)>=59400))-1; % times stamp between 8am to 10pm
                        c10b=intersect(v10b,intersect(t10b,tt10b));%common indices between the v1 and t1

                        if (~isempty(c10b))
                            w10b=time(c10b(1));

                            for k=1:length(c10b)
                                if ((length(c10b)>1) && (c10b(k+1)==c10b(k)+1))
                                    w10b=w10b+time(c10b(k+1));
                                    %t_seg{i,l}=[t_seg{i,l},time(c(k)+1)];
                                else
                                    wt10b{i,l}=[wt10b{i,l},w10b];%storing waiting time for 30 days for three city
%                                     wait9b{i,l,taxi_no(j)+1} = [wait9b{i,l,taxi_no(j)+1},w9b];
                                    w10b=0;
                                end
                            end
...
%         inter_len1_v2 = length(intersect(cty_tx_ind{1,1},cty_tx_ind{1,2}))
%         inter_len2_v2 = length(intersect(cty_tx_ind{1,2},cty_tx_ind{1,3}))
%         inter_len3_v2 = length(intersect(cty_tx_ind{1,1},cty_tx_ind{1,3}))
            
        
        clear m1 m m2 file   
 end%end for 30 days
 w=D;
save(['Waiting_time_taxis_half_avg_below_1_bombay_bang_delhi_2013',month,'_v2.mat']);