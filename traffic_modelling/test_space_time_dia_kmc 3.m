...
sigcyc=120; %Signal cycle = time signal is red + time signal is green
...
for jjjjj=1:p
    ...
    hold on;plot(space_position_eachcar{1,jjjjj}(y(jjj)+1:y(jjj+1)),c1(y(jjj)+1:y(jjj+1)),'color',[jjjjj/p,1-(jjjjj/p),jjjjj/p]);
    end
end