...
%                 [alpha0(sig,p), xmin0(sig,p), L0(sig,p)] = plfit(tempwt,'finite','nosmall','sample',100,'limit',10);%fixing the xmin to be 3.0
                [alpha0(sig,p), xmin0(sig,p), L0(sig,p)] = plfit(tempwt,'sample',100);%fixing the xmin to be 3.0
...
%                 [alpha1(sig,p), xmin1(sig,p), L1(sig,p)] = plfit(tempwt,'finite','nosmall','sample',100,'limit',10);%fixing the xmin to be 3.0                
                [alpha1(sig,p), xmin1(sig,p), L1(sig,p)] = plfit(tempwt,'sample',100);%fixing the xmin to be 3.0                
...
%                 [alpha5(sig,p), xmin5(sig,p), L5(sig,p)] = plfit(tempwt,'finite','nosmall','sample',100,'limit',10);%fixing the xmin to be 3.0                
                [alpha5(sig,p), xmin5(sig,p), L5(sig,p)] = plfit(tempwt,'sample',100);%fixing the xmin to be 3.0                
...
%                 [alpha9(sig,p), xmin9(sig,p), L9(sig,p)] = plfit(tempwt,'finite','nosmall','sample',100,'limit',10);%fixing the xmin to be 3.0                
                [alpha9(sig,p), xmin9(sig,p), L9(sig,p)] = plfit(tempwt,'sample',100);%fixing the xmin to be 3.0                
...
%                 [alpha10(sig,p), xmin10(sig,p), L10(sig,p)] = plfit(tempwt,'finite','nosmall','sample',100,'limit',10);%fixing the xmin to be 3.0                
                [alpha10(sig,p), xmin10(sig,p), L10(sig,p)] = plfit(tempwt,'sample',100);%fixing the xmin to be 3.0                
            end
        end
    end    
...
save(['power_law_exponents_finite_sampled100.mat'],'alpha0','xmin0','L0','alpha1','xmin1','L1','alpha5','xmin5','L5','alpha9','xmin9','L9','alpha10','xmin10','L10');