...
% tsimul=5000; %Total time of simulation
...
% P=20; %P is total number of cars
...
%figure; loglog(sort(wt1{1},'descend'),[1:length(wt1{1})]/length(wt1{1}),'b o');
...
save(['wait_cor_batch' num2str(batch) '_tsimul' num2str(tsimul) '_sigcyc' num2str(sigcyc) '_dr' num2str(dutyratio*10) '_p' num2str(P) '_L' num2str(round(roadlength)) '.mat'],'wt','wt1','wait');
