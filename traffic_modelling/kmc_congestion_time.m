roadlength=300; %total length of the road
tsimul=1000*5; %Total time of simulation
sigcyc=100; %time signal is red + time signal is green
dutyratio=.5; %ratio of green signal time to red signal time

thresholdspeed=0.1; %speed below which a car is considered to be in a congestion
P=120; %P is total number of cars
