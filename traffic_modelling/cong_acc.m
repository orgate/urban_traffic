...
function wt = cong_acc(batch,silon,alp,bet,ret)
...
rr = 0.0;%str2num(rr);%0.6;    %limit of random term in the acceleration
...
save(['wait' num2str(batch) '_' num2str(silon) '_' num2str(rr) '_' num2str(alp) '_' num2str(bet) '_' num2str(ret) '.mat'],'wt','wt1');