...
P=[5:5:95];%no of cars in the road
L=101; %length of road (includes the traffic signal occupying unit length)
maxtime=1000; %Max time upto which simulation is done
c=1; %maximum speed of cars
sigcyc=maxtime+1; %Signal cycle
dutyratio=1; %duty ratio
